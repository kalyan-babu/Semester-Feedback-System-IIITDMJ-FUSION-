...
<!--      <link href="http://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">-->
    ...
    <body>
        ...
        <div class="main-container row">
				...
				<br><h5>Modify Data Base:</h5><br>
						<div class="row">
							<div class="col s12 m6 l3"></div>
							<div class="col s12 m6 l3"><a class="waves-effect waves-light btn modal-trigger" href="#modal1">INSERT</a></div>
							<div class="col s12 m6 l3"><a class="waves-effect waves-light btn modal-trigger" href="#modal2">DELETE</a></div>
						</div>
				<br>
				<br><h5>View Data Base:</h5><br>
				
						<div class="row">
							<div class="col s12 m6 l3"></div>
							<div class="col s12 m6 l3"><a class="waves-effect btn" href = "/sem">VIEW</a></div>
